...
DOWNLOAD_FIRMWARE() {
    ...
    wget -q --load-cookies cookies.txt "https://drive.usercontent.google.com/download?id=$FILE_ID&export=download&confirm=$CONFIRM&uuid=$UUID" -O "${DOWN_DIR}/SM-A346E_OneUi85_firmware.zip"; \
    rm -f cookies.txt
